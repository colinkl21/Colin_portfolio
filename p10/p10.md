...
``` r
plot_model(logR_wave2, group.terms = c(1, 2, 2, 1, 2), colors=c("#4DBBD5FF","#E64B35FF"), show.values = TRUE, value.offset = .3, vline.color = "#1B191999", title = "Using Wave 2 Predictors to Predict Coming Out in Wave 3", type ="est", transform = NULL) + theme_classic() + theme(plot.title = element_text(face = "bold", hjust = 0.5)) + scale_x_discrete(labels=c("Felt Stigma", "Internalized Homophobia", "Community Connectedness","Social Support", "Everyday Discrimination"))
```
...
``` r
semPaths(fit1, "std", layout = "tree", edge.width = 1.5, edge.label.cex = 1.5, node.width=2, residuals=FALSE, nodeLabels = c("Coming Out", "Internalized Homophobia", "Social Support", "Everyday Discrimination", "Community Connectedness", "Felt Stigma"), label.cex =3.6)
```
...
``` r
semPaths(fit2, "std", layout = "tree", edge.width = 1.5, edge.label.cex = 1.5, node.width=2, residuals=FALSE, nodeLabels = c("Coming Out", "Internalized Homophobia", "Social Support", "Everyday Discrimination", "Community Connectedness", "Felt Stigma"), label.cex =3.6)
```
...
``` r
semPaths(fit3, "std", layout = "tree", edge.width = 1.5, edge.label.cex = 1.5, node.width=2, residuals=FALSE, nodeLabels = c("Coming Out", "Internalized Homophobia", "Social Support", "Everyday Discrimination", "Community Connectedness", "Felt Stigma"), label.cex =3.6)
```
